...
instance BergerLeightonGraph {l:ℕ} (go : Fin 4 → ℤ×ℤ → ℤ×ℤ) (fold : Fin l → (ℤ×ℤ)) (ph : Fin l → Bool)
(hl : ∀ a, ¬ nearby go a a)
...
instance ScoreGraph {l:ℕ} (go : Fin 4 → ℤ×ℤ → ℤ×ℤ) (fold : Fin l → (ℤ×ℤ)) (ph : Fin l → Bool)
: SimpleGraph (Fin l) := {
...
def edgeFun   {l:ℕ} (go : Fin 4 → ℤ×ℤ → ℤ×ℤ) (fold : Fin l → (ℤ×ℤ)) (ph : Fin l → Bool) :
...
:= λ ik ↦ ⟨Sym2.mk ik,by
  ...
  exact Q
⟩
def edgeFunBL   {l:ℕ} (go : Fin 4 → ℤ×ℤ → ℤ×ℤ) (fold : Fin l → (ℤ×ℤ)) (ph : Fin l → Bool)
(hl : ∀ a, ¬ nearby go a a)
(hs : Symmetric (λ a b ↦ nearby go a b))
:
...
theorem edgeFunBL_surjective    {l:ℕ} (go : Fin 4 → ℤ×ℤ → ℤ×ℤ) (fold : Fin l → (ℤ×ℤ)) (ph : Fin l → Bool)
(hl : ∀ a, ¬ nearby go a a)
(hs : Symmetric (λ a b ↦ nearby go a b))
...
theorem edgeFun_surjective    {l:ℕ} (go : Fin 4 → ℤ×ℤ → ℤ×ℤ) (fold : Fin l → (ℤ×ℤ)) (ph : Fin l → Bool)
...
theorem edgeFunBL_injective    {l:ℕ} (go : Fin 4 → ℤ×ℤ → ℤ×ℤ) (fold : Fin l → (ℤ×ℤ)) (ph : Fin l → Bool)
(hl : ∀ a, ¬ nearby go a a)
(hs : Symmetric (λ a b ↦ nearby go a b))
...
theorem edgeFun_injective    {l:ℕ} (go : Fin 4 → ℤ×ℤ → ℤ×ℤ) (fold : Fin l → (ℤ×ℤ)) (ph : Fin l → Bool)
...
theorem points_imcs  {l:ℕ} (go : Fin 4 → ℤ×ℤ → ℤ×ℤ) (fold : Fin l → (ℤ×ℤ)) (ph : Fin l → Bool)
...
theorem points_icmsBL  {l:ℕ} (go : Fin 4 → ℤ×ℤ → ℤ×ℤ) (fold : Fin l → (ℤ×ℤ)) (ph : Fin l → Bool)
(hl : ∀ a, ¬ nearby go a a)
(hs : Symmetric (λ a b ↦ nearby go a b))
...
theorem fiber {l:ℕ} (go : Fin 4 → ℤ×ℤ → ℤ×ℤ) (fold : Fin l → (ℤ×ℤ)) (ph : Fin l → Bool):
...
theorem fiber_more  {l:ℕ} (go : Fin 4 → ℤ×ℤ → ℤ×ℤ) (fold : Fin l → (ℤ×ℤ)) (ph : Fin l → Bool):
Fintype.card (SimpleGraph.Dart (ScoreGraph go fold ph ))
  ≤ l * l := by
...
theorem icms  {l:ℕ} (go : Fin 4 → ℤ×ℤ → ℤ×ℤ) (fold : Fin l → (ℤ×ℤ)) (ph : Fin l → Bool)
(hl : ∀ a, ¬ nearby go a a)
(hs : Symmetric (λ a b ↦ nearby go a b))
