...
b = 0 ∨ b = 1 ∨ b = 2 ∨ b = 3 := by
  ...
  cases this;left;exact Fin.ext h;
  cases h;right;left;exact Fin.ext h_1
  cases h_1;right;right;left;exact Fin.ext h
  right;right;right;exact Fin.ext h

theorem rotateIndex_surjective : Function.Surjective rotateIndex := by
  intro b
  cases (four_choices b);
  subst h;exists 3;cases h;subst h_1;exists 2;cases h_1;subst h;exists 0;subst h;exists 1
...
theorem reflectIndex_surjective : Function.Surjective reflectIndex := by
  ...
  cases h;subst h_1;
  exists 0;
  cases h_1;subst h;exists 1;cases h;subst h_1;exists 3;subst h_1;exists 2

theorem rotate_injective : Function.Injective rotate := by
  intro x y hxy;unfold rotate at hxy;simp at hxy;apply Prod.ext;tauto;tauto

theorem reflect_injective : Function.Injective reflect := by
  intro x y hxy;unfold reflect at hxy;simp at hxy;apply Prod.ext;tauto;tauto
