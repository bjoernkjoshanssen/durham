...
def CI_parsimoniousreduction : ParsimoniousReduction Knapsack2 CursiveWalk := {
...
noncomputable def KI_parsimoniousreduction : ParsimoniousReduction CursiveWalk Knapsack2 := {
...
--   exact UNIQUE_reduces_C h
--   constructor
--   intro hu;exfalso; let s :=    (Classical.choice hu).default; exact h (Nonempty.intro s)
--   intro hu;exfalso; let s := KS (Classical.choice hu).default; exact h (Nonempty.intro s)
-- }
